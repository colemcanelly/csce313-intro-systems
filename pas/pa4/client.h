 ...
 */
void worker_thread_data_helper ( char* __d_msg, BoundedBuffer* p_resbuf, TCPRequestChannel* p_channel );
 ...
 * @param   __bufcap    Maximum buffer capacity, specified at run time
 */
void worker_thread_file_helper ( char* __f_msg, TCPRequestChannel* p_channel, int __bufcap );
 ...
 */
void worker_thread_function ( BoundedBuffer* p_reqbuf, BoundedBuffer* p_resbuf, TCPRequestChannel* p_channel, int __bufcap );
...
private:
    std::thread* __t;
public:
    worker( BoundedBuffer* p_reqbuf, BoundedBuffer* p_resbuf, const std::string _ip_address, const std::string _port_no, int __bufcap )
    {
        TCPRequestChannel* p_private_chan = new TCPRequestChannel{_ip_address, _port_no};
